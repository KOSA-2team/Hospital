...
-- [진료완료: status 3] - 35건
    (1, 1, '2025-12-06 09:00:00', 3),
    (2, 2, '2025-12-06 09:30:00', 3),
    (3, 3, '2025-12-06 10:00:00', 3),
    (4, 4, '2025-12-06 10:30:00', 3),
    (5, 5, '2025-12-06 11:00:00', 3),
    (6, 6, '2025-12-06 11:30:00', 3),
    (7, 7, '2025-12-06 13:00:00', 3),
    (8, 8, '2025-12-06 13:30:00', 3),
    (9, 9, '2025-12-06 14:00:00', 3),
    (10, 10, '2025-12-06 14:30:00', 3),
    (11, 11, '2025-12-06 15:00:00', 3),
    (12, 12, '2025-12-06 15:30:00', 3),
    (13, 13, '2025-12-06 16:00:00', 3),
    (14, 14, '2025-12-06 16:30:00', 3),
    (15, 15, '2025-12-06 17:00:00', 3),
    (16, 16, '2025-12-06 09:00:00', 3),
    (17, 17, '2025-12-06 09:30:00', 3),
    (18, 18, '2025-12-06 10:00:00', 3),
    (19, 19, '2025-12-06 10:30:00', 3),
    (20, 20, '2025-12-06 11:00:00', 3),
    (21, 21, '2025-12-06 11:30:00', 3),
    (22, 22, '2025-12-06 13:00:00', 3),
    (23, 23, '2025-12-06 13:30:00', 3),
    (24, 24, '2025-12-06 14:00:00', 3),
    (25, 25, '2025-12-06 14:30:00', 3),
    (26, 1, '2025-12-06 15:00:00', 3),
    (27, 2, '2025-12-06 15:30:00', 3),
    (28, 3, '2025-12-06 16:00:00', 3),
    (29, 4, '2025-12-06 16:30:00', 3),
    (30, 5, '2025-12-06 17:00:00', 3),
    (1, 6, '2025-12-07 09:00:00', 3),
    (2, 7, '2025-12-07 09:30:00', 3),
    (3, 8, '2025-12-07 10:00:00', 3),
    (4, 9, '2025-12-07 10:30:00', 3),
    (5, 10, '2025-12-07 11:00:00', 3),
    -- [예약확정: status 1]
    (6, 11, '2025-12-08 09:00:00', 1),
    (7, 12, '2025-12-08 10:00:00', 1),
    (8, 13, '2025-12-08 11:00:00', 1),
    (9, 14, '2025-12-08 14:00:00', 1),
    (10, 15, '2025-12-08 15:00:00', 1),
    -- [예약요청: status 0]
    (11, 16, '2025-12-08 09:00:00', 0),
    (12, 17, '2025-12-08 10:00:00', 0),
    (13, 18, '2025-12-08 11:00:00', 0),
    (14, 19, '2025-12-08 14:00:00', 0),
    (15, 20, '2025-12-08 15:00:00', 0),
    -- [예약취소: status 2]
    (16, 21, '2025-12-07 09:00:00', 2),
    (17, 22, '2025-12-07 10:00:00', 2),
    (18, 23, '2025-12-07 11:00:00', 2),
    (19, 24, '2025-12-07 14:00:00', 2),
    (20, 25, '2025-12-07 15:00:00', 2);
...
INSERT INTO `Treatment` (`reservation_num`, `diagnosis`, `treatment`, `treatment_date`) VALUES
    (1, '급성 위염', '위장약 처방 및 식단 조절 권고', '2025-12-06 09:15:00'),
    (2, '고혈압', '혈압 강하제 처방', '2025-12-06 09:45:00'),
    (3, '맹장염 의심', '상급 병원 이송 및 수술 권유', '2025-12-06 10:15:00'),
    (4, '타박상', '물리치료 및 파스 처방', '2025-12-06 10:45:00'),
    (5, '감기', '해열제 및 기침약 처방', '2025-12-06 11:15:00'),
    (6, '독감', '타미플루 처방 및 격리 권고', '2025-12-06 11:45:00'),
    (7, '아토피 피부염', '보습제 및 스테로이드 연고 처방', '2025-12-06 13:15:00'),
    (8, '여드름', '피지 조절제 처방', '2025-12-06 13:45:00'),
    (9, '중이염', '항생제 처방', '2025-12-06 14:15:00'),
    (10, '알레르기 비염', '항히스타민제 처방', '2025-12-06 14:45:00'),
    (11, '허리 디스크', '도수 치료 및 진통제 처방', '2025-12-06 15:15:00'),
    (12, '발목 염좌', '깁스 및 물리치료', '2025-12-06 15:45:00'),
    (13, '결막염', '안약 처방', '2025-12-06 16:15:00'),
    (14, '안구 건조증', '인공눈물 처방', '2025-12-06 16:45:00'),
    (15, '임신 확인', '초음파 검사 및 엽산 처방', '2025-12-06 17:15:00'),
    (16, '방광염', '항생제 처방', '2025-12-06 09:15:00'),
    (17, '두통', '진통제 처방 및 MRI 권유', '2025-12-06 09:45:00'),
    (18, '뇌진탕', 'CT 촬영 및 입원 관찰', '2025-12-06 10:15:00'),
    (19, '만성 피로', '비타민 주사 및 휴식 권고', '2025-12-06 10:45:00'),
    (20, '비만', '식욕 억제제 처방 및 운동 처방', '2025-12-06 11:15:00'),
    (21, '식중독', '수액 처방 및 금식', '2025-12-06 11:45:00'),
    (22, '화상', '드레싱 및 연고 처방', '2025-12-06 13:15:00'),
    (23, '충치', '레진 치료', '2025-12-06 13:45:00'),
    (24, '사랑니 통증', '발치 예약 및 진통제 처방', '2025-12-06 14:15:00'),
    (25, '대상포진', '항바이러스제 처방', '2025-12-06 14:45:00'),
    (26, '역류성 식도염', '제산제 처방', '2025-12-06 15:15:00'),
    (27, '당뇨', '인슐린 처방 및 식이요법 교육', '2025-12-06 15:45:00'),
    (28, '손가락 골절', '핀 고정 수술', '2025-12-06 16:15:00'),
    (29, '하지정맥류', '압박 스타킹 처방', '2025-12-06 16:45:00'),
    (30, '장염', '지사제 및 유산균 처방', '2025-12-06 17:15:00'),
    (31, '편도선염', '항생제 및 해열제', '2025-12-07 09:15:00'),
    (32, '무좀', '항진균제 연고', '2025-12-07 09:45:00'),
    (33, '습진', '스테로이드 로션', '2025-12-07 10:15:00'),
    (34, '축농증', '코 세척 및 항생제', '2025-12-07 10:45:00'),
    (35, '이명', '혈액순환 개선제', '2025-12-07 11:15:00');
